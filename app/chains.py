...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            Your job is to write a cold email to the client regarding the job mentioned above describing the capability of Featly 
            in fulfilling their needs.
            Also add the most relevant ones from the following links to showcase Fealty's portfolio: {link_list}
            Remember you are Mohan, BDE at Fealty. 
